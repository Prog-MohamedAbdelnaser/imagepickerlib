...
import com.esafirm.imagepickerv2.BuildConfig;
import com.esafirm.imagepickerv2.R;
import com.esafirm.imagepickerv2.features.camera.CameraHelper;
import com.esafirm.imagepickerv2.features.camera.DefaultCameraModule;
...
import com.esafirm.imagepickerv2.features.fileloader.DefaultImageFileLoader;
import com.esafirm.imagepickerv2.features.recyclers.RecyclerViewManager;
import com.esafirm.imagepickerv2.helper.ConfigUtils;
import com.esafirm.imagepickerv2.helper.ImagePickerPreferencesv2;
import com.esafirm.imagepickerv2.helper.IpCrasher;
...
import com.esafirm.imagepickerv2.view.SnackBarView;
...
import static com.esafirm.imagepickerv2.helper.ImagePickerPreferencesv2.PREF_WRITE_EXTERNAL_STORAGE_REQUESTED;

public class ImagePickerFragmentV2 extends Fragment implements ImagePickerView {
    ...
    private ImagePickerPreferencesv2 preferences;
    ...
    public ImagePickerFragmentV2() {
        // Required empty public constructor.
    }

    public static ImagePickerFragmentV2 newInstance(@Nullable ImagePickerConfig config,
                                                    @Nullable CameraOnlyConfig cameraOnlyConfig) {
        ImagePickerFragmentV2 fragment = new ImagePickerFragmentV2();
    ...
    private void setupComponents() {
        preferences = new ImagePickerPreferencesv2(getActivity());
    ...
    private void getDataWithPermission() {
        getData();
       int rc = ActivityCompat.checkSelfPermission(getActivity(),storagePermission());
    ...
    private void requestWriteExternalPermission() {
        ...
        final String[] permissions = new String[]{storagePermission()};

        if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), storagePermission())) {
    ...
    private void requestCameraPermissions() {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(),storagePermission()) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (checkForRationale(permissions)) {
            ...
            final String permission = ImagePickerPreferencesv2.PREF_CAMERA_REQUESTED;
            if (!preferences.isPermissionRequested(permission)) {
                preferences.setPermissionRequested(permission);
                requestPermissions(permissions.toArray(new String[permissions.size()]), RC_PERMISSION_REQUEST_CAMERA);
            } else {
    ...
    public void captureImageWithPermission() {
        Log.e("ImageWithPermission",Build.VERSION.SDK_INT +"");
        ...
        final boolean isWriteGranted = ActivityCompat
                .checkSelfPermission(getActivity(), storagePermission()) == PackageManager.PERMISSION_GRANTED;
